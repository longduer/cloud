...
@Slf4j
@Component
public class LeungGatewayRequestFilter implements GlobalFilter {
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        ServerHttpRequest build = request.mutate().header(LeungConstant.ZUUL_TOKEN_HEADER, new String(token)).build();
    ...
    private Mono<Void> makeResponse(ServerHttpResponse response, LeungResponse febsResponse) {
