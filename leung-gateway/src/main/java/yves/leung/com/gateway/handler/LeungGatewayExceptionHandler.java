package yves.leung.com.gateway.handler;
...
@Slf4j
public class LeungGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public LeungGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
