package yves.leung.com.gateway.configure;
...
@Configuration
public class LeungGatewaySentinelConfigure {
    private final List<ViewResolver> viewResolvers;
    private final ServerCodecConfigurer serverCodecConfigurer;

    public LeungGatewaySentinelConfigure(ObjectProvider<List<ViewResolver>> viewResolversProvider,
